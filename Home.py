...
if st.button('Preprocess data and make predictions'):
    ...
    out = pd.concat([df_output[df_output.columns[:4]], empty_col,df_output[df_output.columns[4:]],empty_col,data['site_T'],empty_col,data['site_M1&2'], empty_col, data['classifications'],empty_col, comp[comp.columns[4:]], empty_col, data['checks']], axis = 1 )
